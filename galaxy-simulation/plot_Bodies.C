//LEAVING THIS UNDEVELOPED, AS ROOT IS NO LONGER INSTALLED ON MY PC => MOVING PLOTTING TO PYTHON
//LEAVING IT HERE FOR COMPLETENESS, AND FOR INSPIRATION FOR THE NEW PLOTTING SCRIPTS
...
for(int i = 0; i < plot_number; i++)
{
	...
	TCanvas* temp_canvas = new TCanvas(c, c, 350, 400);
